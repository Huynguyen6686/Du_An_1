 ...
 * @author Admin
 */
public class QuanLyKhachHang1 extends javax.swing.JDialog implements poly.books.controller.QLKhachHangController {
    
    List<KhachHang> ListKH = new ArrayList<>();
    KhachHangDAO KHdao = new KhachHangDAO();
    /**
     * Creates new form QuanLyKhachHang1
     */
    public QuanLyKhachHang1() {
        initComponents();
        fillToTable();
